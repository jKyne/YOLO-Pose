...
from utils import read_truths_args, read_truths, get_all_files, read_truths_pose
...
class listDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.train:
            ...
            img, label, label_1, label_2 = load_data_detection(imgpath, self.shape, jitter, hue, saturation, exposure)
            ...
            lab_pose_path = imgpath.replace('images', 'labels_pose').replace('JPEGImages', 'labels_pose').replace('.jpeg', '.txt').replace('.jpg','.txt')
